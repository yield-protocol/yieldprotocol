...
contract Thunderswap_YZapIn is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    address public constant routerAddress = 0xf6135FCb4A0F469DcBb3e6D83520Dc21825A0001;
    ...
    IUniswapV2Factory
        ...
        0x6FCC6a77ee6F383395c630EEDe1EE928dFF4E331
    );

    address
        private constant wethTokenAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//WBNB
    ...
    function convertTokenToETH(address _toWhomToIssue, address _tokenToExchange, uint256 _amount) external returns (uint256) {
        ...
        IERC20(_tokenToExchange).approve(address(uniswapRouter), _amount);
