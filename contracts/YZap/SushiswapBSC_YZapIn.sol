...
contract SushiswapBSC_YZapIn is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    IUniswapV2Router02 private constant pancakeswapRouter = IUniswapV2Router02(
    ...
    function YZapIn(
        ...
        IUniswapV2Pair uniPair = IUniswapV2Pair(_toPairAddress);
        return YZapInTokens(_toWhomToIssue, _fromTokenAddress, uniPair.token0(), uniPair.token1(), _amount, _minPoolTokens);
    }
    ...
    function _getIntermediate(
        ...
        if (_FromTokenContractAddress == _ToUnipoolToken0) {
            ...
            IUniswapV2Pair pair = IUniswapV2Pair(
                PancakeSwapV2FactoryAddress.getPair(
                    _ToUnipoolToken0,
                    _ToUnipoolToken1
                )
            );
    ...
    function _calculateSwapOutput(
        ...
        address pairA = PancakeSwapV2FactoryAddress.getPair(_from, _to);
        ...
        if (pairA != address(0)) {
            ...
            amtA = pancakeswapRouter.getAmountsOut(_amt, pathA)[1];
        }
        ...
        if ((_from != wethTokenAddress) && _to != wethTokenAddress) {
            ...
            amtB = pancakeswapRouter.getAmountsOut(_amt, pathB)[2];
        }
    ...
    */
    function _token2Token(
        ...
        if (_FromTokenContractAddress == address(0)) {
            ...
            tokenBought = pancakeswapRouter.swapExactETHForTokens.value(
                tokens2Trade
            ...
            tokenBought = pancakeswapRouter.swapExactTokensForETH(
                tokens2Trade,
                1,
                path,
                address(this),
            ...
            if (_FromTokenContractAddress != wethTokenAddress) {
                if (_ToTokenContractAddress != wethTokenAddress) {
                    // check output via tokenA -> tokenB
                    address pairA = PancakeSwapV2FactoryAddress.getPair(
                        _FromTokenContractAddress,
                    ...
                    uint256 amtA;
                    if (pairA != address(0)) {
                        amtA = pancakeswapRouter.getAmountsOut(
                            tokens2Trade,
                            pathA
                        )[1];
                    }
                    ...
                    uint256 amtB = pancakeswapRouter.getAmountsOut(
                        tokens2Trade,
                        pathB
                    )[2];
